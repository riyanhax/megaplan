            ...
            <div class="cloud-desc bg-white">
                <div class="cloud-desc_block">
                    <div class="cloud-button">
                        <a class="button" href="/prices/#cloud_prices" title=""><span class="button-green">Посмотреть цены</span></a>
                    </div>
                </div>
            </div>
            <div class="cloud-desc bg-grey">
                <div class="cloud-desc_block">
                    <div class="cloud-button">
                        <a class="button" href="/prices/#server_prices" title=""><span class="button-yellow">Посмотреть цены</span></a>
                    </div>
                </div>
            </div>
        </div>
