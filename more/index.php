...
$APPLICATION->SetTitle("Задачи закрываются, клиенты не теряются");?>
...
<section class="content-crop section-contacts bg-white content-crop-more">
	<div class="section-wrapper section-wrapper-more bg-white more-mobile">
		...
		<div class="more-block-white more-block-comfort">
			...
			<span class="more-text-thin">Минимум времени для старта. Персональный менеджер всегда в вашем распоряжении, начиная с бесплатного периода. Интуитивный интерфейс максимально понятен и имеет гибкие настройки. Мегаплан включает CRM и систему управления проектами. Вы можете выбрать одно из направлений либо использовать их вместе.</span>
			<p></p>
		...
		<div class="more-block-gray-footer-form more-block-gray-form">
			<div class="more-form">
